                ...
                <div className="bringcon-logo-container">
                    ...
                    <div className="notice-container">
                        <div className="notice-1">
                            ...
                            <p>브링콘(BRINGCON)은 유튜브 시장에서의 <br className="pc"/>
                            원 저작자와 크리에이터 간 <br className="pc ipad"/>
                            콘텐츠 저작권 문제를 해결하기 위한 <br className="pc"/>
                            '콘텐츠 저작권 전자상거래 플랫폼'입니다.</p>
                        </div>
                        <div className="notice-2">
                            <h2>원 저작자와 <br/>크리에이터의 WIN-WIN</h2>
                            <p>브링콘을 통하여 원 저작자는 <br className="pc"/>
                            수수료를 지불하고 <br className="ipad"/> 자신의 콘텐츠 사용권을 판매, <br className="pc"/>
                            크리에이터는 원하는 콘텐츠 사용권을 구매하여 <br className="pc ipad"/>
                            본인 채널에 활용할 수 있습니다.</p>
                        </div>
                        <div className="notice-3">
                            <h2>트렌드 분석을 통한 <br/>인기 콘텐츠 엄선</h2>
                            <p>브링콘(BRINGCON)은 크리에이터들이 <br className="pc"/>
                            더 양질의 콘텐츠를 제공받을 수 있도록 <br className="pc ipad"/>
                            유튜브 콘텐츠를 지속적으로 분석하여 <br className="pc"/>
                            실시간으로 자사 콘텐츠를 검수하고 있습니다.</p>
                        </div>
                        <div className="notice-4">
                            <h2>콘텐츠 저작권 보호 및 <br/>안전한 저작권 거래</h2>
                            <p>브링콘(BRINGCON)은 첫 회원가입 시, <br className="pc"/>
                            유튜브 채널 인증을 통해 <br className="ipad"/>크리에이터의 채널에서 <br className="pc"/>
                            시시각각으로 콘텐츠가 적법하게 사용되고 있는지 <br className="pc ipad"/>
                            확인하는 모니터링 알고리즘을 시행하고 있습니다.</p>
                        </div>
                    </div>
                </div>
            </div>
